...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  get job() { return this.prisma.job; }
  get candidate() { return this.prisma.candidate; }
  get application() { return this.prisma.application; }
  get screeningResult() { return this.prisma.screeningResult; }
  get interview() { return this.prisma.interview; }
  get auditLog() { return (this.prisma as any).auditLog; }
